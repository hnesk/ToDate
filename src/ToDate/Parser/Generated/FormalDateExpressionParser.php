...
class FormalDateExpressionParser extends Basic
{
    ...
    public function match_Token ($stack = array())
    {
    ...
    public function match_TokenList ($stack = array())
    {
    ...
    public function match_Feature ($stack = array())
    {
    ...
    public function match_Unit ($stack = array())
    {
    ...
    public function match_Offset ($stack = array())
    {
    ...
    public function match_WeekNumber ($stack = array())
    {
    ...
    public function match_WeekList ($stack = array())
    {
    ...
    public function match_DayOfWeek ($stack = array())
    {
    ...
    public function match_DayOfWeekList ($stack = array())
    {
    ...
    public function match_Day ($stack = array())
    {
    ...
    public function match_DayList ($stack = array())
    {
    ...
    public function match_Month ($stack = array())
    {
    ...
    public function match_MonthList ($stack = array())
    {
    ...
    public function match_Year ($stack = array())
    {
    ...
    public function match_YearList ($stack = array())
    {
    ...
    public function match_Date ($stack = array())
    {
    ...
    public function match_Easter ($stack = array())
    {
        $matchrule = "Easter"; $result = $this->construct($matchrule, $matchrule, null);
        $_114 = NULL;
        do {
            if (( $subres = $this->literal( 'Easter' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_114 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
    ...
    public function match_Equal ($stack = array())
    {
    ...
    public function match_DateExpression ($stack = array())
    {
        $matchrule = "DateExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_132 = NULL;
        do {
            if (( $subres = $this->literal( 'Date' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_132 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
    ...
    public function match_DateModuloExpression ($stack = array())
    {
        $matchrule = "DateModuloExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_143 = NULL;
        do {
            if (( $subres = $this->literal( 'DateModulo' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_143 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
            $matcher = 'match_'.'Equal'; $key = $matcher; $pos = $this->pos;
            $subres = ( $this->packhas( $key, $pos ) ? $this->packread( $key, $pos ) : $this->packwrite( $key, $pos, $this->$matcher(array_merge($stack, array($result))) ) );
            if ($subres !== FALSE) {
    ...
    public function match_DayOfWeekOfMonthExpression ($stack = array())
    {
        $matchrule = "DayOfWeekOfMonthExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_151 = NULL;
        do {
            if (( $subres = $this->literal( 'DayOfWeekOfMonth' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_151 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
            $matcher = 'match_'.'Equal'; $key = $matcher; $pos = $this->pos;
            $subres = ( $this->packhas( $key, $pos ) ? $this->packread( $key, $pos ) : $this->packwrite( $key, $pos, $this->$matcher(array_merge($stack, array($result))) ) );
            if ($subres !== FALSE) {
    ...
    public function match_DayOfMonthExpression ($stack = array())
    {
        $matchrule = "DayOfMonthExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_158 = NULL;
        do {
            if (( $subres = $this->literal( 'DayOfMonth' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_158 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
            $matcher = 'match_'.'Equal'; $key = $matcher; $pos = $this->pos;
            $subres = ( $this->packhas( $key, $pos ) ? $this->packread( $key, $pos ) : $this->packwrite( $key, $pos, $this->$matcher(array_merge($stack, array($result))) ) );
            if ($subres !== FALSE) {
    ...
    public function match_DayAndMonthExpression ($stack = array())
    {
        $matchrule = "DayAndMonthExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_167 = NULL;
        do {
            if (( $subres = $this->literal( 'DayAndMonth' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_167 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
            $matcher = 'match_'.'Equal'; $key = $matcher; $pos = $this->pos;
            $subres = ( $this->packhas( $key, $pos ) ? $this->packread( $key, $pos ) : $this->packwrite( $key, $pos, $this->$matcher(array_merge($stack, array($result))) ) );
            if ($subres !== FALSE) {
    ...
    public function match_DayOfWeekExpression ($stack = array())
    {
        $matchrule = "DayOfWeekExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_174 = NULL;
        do {
            if (( $subres = $this->literal( 'DayOfWeek' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_174 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
            $matcher = 'match_'.'Equal'; $key = $matcher; $pos = $this->pos;
            $subres = ( $this->packhas( $key, $pos ) ? $this->packread( $key, $pos ) : $this->packwrite( $key, $pos, $this->$matcher(array_merge($stack, array($result))) ) );
            if ($subres !== FALSE) {
    ...
    public function match_MonthExpression ($stack = array())
    {
        $matchrule = "MonthExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_181 = NULL;
        do {
            if (( $subres = $this->literal( 'Month' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_181 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
            $matcher = 'match_'.'Equal'; $key = $matcher; $pos = $this->pos;
            $subres = ( $this->packhas( $key, $pos ) ? $this->packread( $key, $pos ) : $this->packwrite( $key, $pos, $this->$matcher(array_merge($stack, array($result))) ) );
            if ($subres !== FALSE) {
    ...
    public function match_YearExpression ($stack = array())
    {
        $matchrule = "YearExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_188 = NULL;
        do {
            if (( $subres = $this->literal( 'Year' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_188 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
            $matcher = 'match_'.'Equal'; $key = $matcher; $pos = $this->pos;
            $subres = ( $this->packhas( $key, $pos ) ? $this->packread( $key, $pos ) : $this->packwrite( $key, $pos, $this->$matcher(array_merge($stack, array($result))) ) );
            if ($subres !== FALSE) {
    ...
    public function match_FeatureExpression ($stack = array())
    {
    ...
    public function match_NotExpression ($stack = array())
    {
        $matchrule = "NotExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_206 = NULL;
        do {
            if (( $subres = $this->literal( 'NOT(' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_206 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
    ...
    public function match_Expression ($stack = array())
    {
    ...
    public function match_AndExpression ($stack = array())
    {
        $matchrule = "AndExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_259 = NULL;
        do {
            if (( $subres = $this->literal( 'AND' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_259 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
    ...
    public function match_OrExpression ($stack = array())
    {
        $matchrule = "OrExpression"; $result = $this->construct($matchrule, $matchrule, null);
        $_265 = NULL;
        do {
            if (( $subres = $this->literal( 'OR' ) ) !== FALSE) { $result["text"] .= $subres; } else { $_265 = FALSE; break; }
            if (( $subres = $this->whitespace(  ) ) !== FALSE) { $result["text"] .= $subres; }
            $matcher = 'match_'.'Expression'; $key = $matcher; $pos = $this->pos;
            $subres = ( $this->packhas( $key, $pos ) ? $this->packread( $key, $pos ) : $this->packwrite( $key, $pos, $this->$matcher(array_merge($stack, array($result))) ) );
            if ($subres !== FALSE) {
    ...
    public function match_Result ($stack = array())
    {
