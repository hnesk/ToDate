 ...
 */
class AbstractDateRangeIteratorTest extends TestCase
{
    ...
    {
        self::expectExceptionObject(new \InvalidArgumentException('End needs to be before start, start was "2012-02-09", end was "2012-02-08"', 1414430503));
    ...
    {
        $mockIterator = $this->getMockBuilder(AbstractDateRangeIterator::class)
            ->disableOriginalConstructor()
            ->onlyMethods(['doNext'])
            ->getMock();

        $mockIterator->method('doNext')->willReturnMap(['2012-01-01', '2012-02-29']);
