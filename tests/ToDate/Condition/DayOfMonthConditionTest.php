 ...
 */
class DayOfMonthConditionTest extends TestCase
{
     ...
     * @covers ToDate\Condition\AbstractDateCondition::toArray
     */
    public function testConstructorThrowsExceptionWithBrokenRange()
    {
        self::expectExceptionObject(new \InvalidArgumentException('"1-murks" has to  be an numeric range'));
